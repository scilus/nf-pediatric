...
/*
 * Build a dynamic, publication-ready methods HTML fragment.
 * - Only includes sections for steps actually run (checked via params).
 * - Optionally accepts a Map of tool->version to render an explicit versions list.
 * - Safe if params are missing (defaults to false).
 */

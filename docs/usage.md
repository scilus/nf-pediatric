...
```bash
nextflow run scilus/nf-pediatric --input ./samplesheet.csv --outdir ./results --genome GRCh37 -profile docker
```
...
```bash
nextflow run scilus/nf-pediatric -profile docker -params-file params.yaml
```
